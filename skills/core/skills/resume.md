...
name: resume
type: subskill
purpose: Reconstructs session context from persistent state after a context reset and offers state-aware next actions
---
...
- **"Start fresh":** Proceed to Phase 3 (activate session), then invoke `@utilities/watson-init.md` to start the new-prototype flow.
