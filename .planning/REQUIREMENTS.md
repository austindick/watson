...
- [ ] **CBNV-01**: Codebase-map library book generated by Librarian from faire/frontend monorepo
- [ ] **CBNV-02**: Codebase-map book scoped to product area entry points with per-entry last_verified dates
- [ ] **CBNV-03**: Named experience menu presents known surfaces from codebase-map for user selection
