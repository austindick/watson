#!/usr/bin/env node
// watson-session-end.js — SessionEnd hook for Design Toolkit plugin
// Ported from inline Node.js one-liner in settings.json to a proper readable script.
// Preserves branch+actions state to /tmp/dt-session-end.json and cleans up the active file.
...
const SESSION_END_FILE = '/tmp/dt-session-end.json';
